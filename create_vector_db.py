...
# CONFIGURATION
# ==========================================
# make sure this matches the file name you saved in the last step
...
for chunk in raw_chunks:
    # We map the JSON fields to Metadata here
    # This enables the "Strategy" we discussed (filtering by type)
    doc = Document(
